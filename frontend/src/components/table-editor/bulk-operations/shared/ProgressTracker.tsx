      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="space-y-4">
            ...
            {stats &&
              (stats.processingRate || stats.estimatedTimeRemaining) && (
                <div className="flex items-center justify-center gap-6 pt-2 text-sm text-muted-foreground">
                  ...
                  {stats.estimatedTimeRemaining && (
                    <div className="flex items-center gap-1">
                      ...
                      <span>
                        {formatTimeEstimate(stats.estimatedTimeRemaining)}{' '}
                        remaining
                      </span>
                    </div>
                  )}
      ...
      <Card>
        <CardHeader>
          ...
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            <span>
              {stepMetrics.completed} of {stepMetrics.total} completed
            </span>
            {stepMetrics.errors > 0 && (
              <span className="text-destructive">
                {stepMetrics.errors} errors
              </span>
            )}
